# signable API demo [![Build Status](https://travis-ci.com/paperclipmonkey/signable.svg?token=SsrjjdmEtzcJsGDqjxQw&branch=master)](https://travis-ci.com/paperclipmonkey/signable)
